...
static int ht32f165x_erase(struct flash_bank *bank, unsigned first, unsigned last)
{
    struct target *target = bank->target;
...
static int ht32f165x_protect(struct flash_bank *bank, int set, unsigned first, unsigned last)
{
